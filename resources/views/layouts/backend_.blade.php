...
<!-- <link href="{{ url('/backend/css/font-awesome.css') }}" rel="stylesheet" /> -->
    ...
    <link href="{{ url('/backend/css/zabuto_calendar.css') }}" rel="stylesheet">
    <!-- Custom styles for this template -->
    <link href="{{ url('/backend/css/style2.css') }}" rel="stylesheet">
    <link href="{{ url('/backend/css/style-responsive.css') }}" rel="stylesheet">
    <!-- Jasny CSS -->
    <link rel="stylesheet" href="{{ url('/jasny/jasny-bootstrap.min.css') }}" />
    <link rel="stylesheet" href="{{ url('/jasny/jasny-bootstrap-responsive.min.css') }}" />
    <!-- himg CSS -->
    ...
    *********************************************************************************************************************************************************** -->
    ...
    <header class="header black-bg">
        ...
        <a href="" target="_blank" class="logo">
            <img src="{{ url('/img/coming-soon.png') }}" width="160px" height="45px">
    ...
    <aside>
        <div id="sidebar" class="nav-collapse" style="height:600px;overflow-x: hidden;overflow-y: scroll;">
            ...
            <ul class="sidebar-menu" id="nav-accordion">
                <li>
                    <p class="centered">
                        <img src="{{ url('/img/avatar.jpg') }}" class="img-circle" width="60">
                    </p>
    ...
    *********************************************************************************************************************************************************** -->
    ...
    <footer class="site-footer">
        <div class="text-center">
            Copyright &copy; 2019, All rights reserved | Designed & Developed By <a
                    href="">Piratheesan</a>
        </div>
    </footer>
    <!--footer end-->
...
<script src="{{ url('/backend/js/zabuto_calendar.js') }}"></script>
...
<script>
    window.jQuery || document.write('<script src="{{ url('/jasny/jquery-1.10.1.min.js') }}"><\/script>')
</script>
<script type="text/javascript" src="{{ url('/jasny/jasny-bootstrap.min.js') }}"></script>
<script src="{{ url('/backend/js/common-scripts.js') }}"></script>
<script src="{{ url('/ckeditor/ckeditor.js') }}"></script>
<script src="{{ url('/backend/js/backend-custom.js') }}"></script>
